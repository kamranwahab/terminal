...
// store data in db
router.post("/products/add", checkSessionAuth, async function (req, res, next) {
...
router.get("/products/edit/:id",checkSessionAuth, async function (req, res, next) {
  let product = await Product.findById(req.params.id);
  res.render("products/edit", { product });
});
router.post("/products/edit/:id",checkSessionAuth, async function (req, res, next) {
  let product = await Product.findById(req.params.id);
